...
The module outputs a valid set of outputs only when the identification value is 3.
...
--> The external data input is written into the stack location
...
--> The output of the adder is the data coming out from the stack. The carry-input of the adder is not considered.
...
Instruction 2 — POP PC
------------------------------
Pattern: 01110x0

--> The program counter coming out from the stack and routed to full adder output . The carry-input of the adder is not considered.
...
Instruction 3 — HOLD PC
-------------------------
Pattern: 01111x0

--> The program counter is routed to the output of the full adder. The carry-input of the adder is not considered.

--> The program counter value is selected and not incremented.
...
2. When the program counter is selected for increment operation , the program counter mux select will have a value of 1 , unless explicitly stated.
